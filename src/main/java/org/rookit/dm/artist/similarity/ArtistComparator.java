...
public class ArtistComparator extends AbstractGenreableComparator<Artist> {
	...
	protected Map<String, Double> createTopMap(Artist element1, Artist element2) {
		...
		scores.put(BEGIN_DATE, compareOptionals(element1.getBeginDate(), element2.getBeginDate(), this::compareDate));
		scores.put(END_DATE, compareOptionals(element1.getEndDate(), element2.getEndDate(), this::compareDate));
